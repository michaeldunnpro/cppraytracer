...
// Spheres at (0.25, 0.45, 0.4) radius 0.1 red non-metal
...
int main() {
    ...
    // Define materials
    PBRMaterial red(Color(255, 0, 0), 0.2f, 0.0f);
    // It is expected that metals will look bad in current situation
    PBRMaterial green(Color(0, 255, 0), 0.5f, 1.0f);
