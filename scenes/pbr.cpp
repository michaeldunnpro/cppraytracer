...
int main() {
    ...
    // Define materials
    PBRMaterial copper(Color(0.95, 0.64, 0.54) * 255.0, 0.2f, 1.0f);
    // rough metal needs more samples for specular reflection
    PBRMaterial iron(Color(0.56, 0.57, 0.58) * 255.0, 0.5f, 1.0f, 0.5f, 256);
    PBRMaterial brown(Color(165, 42, 42), 0.2f, 0.0f);
