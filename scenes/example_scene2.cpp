...
int main() {
    ...
    auto scn = scene(camera, scr, 0.6f, 0.5f, 8.0f, Color::from_rgb(141, 157, 184));

    // Define materials
    auto teal = mat(Color::from_rgb(96, 209, 168), 0.0f);
    auto darkBlue = mat(Color::from_rgb(47, 30, 94), 0.5f);
    auto darkPink = mat(Color::from_rgb(138, 51, 94), 0.2f);
    auto purple = mat(Color::from_rgb(67, 52, 89), 0.3f);
    auto darkGrey = mat(Color::from_rgb(61, 64, 62), 0.3f);
    ...
    Color candle = Color::from_rgb(255, 147, 41);
